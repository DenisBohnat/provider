...
public final class ErrorMessages {
	...
	public static final String ACCOUNT_TERMINATED = "Pay off your debt please";
	...
	public static final String DELETE_REQUEST_POSSIBILITY = "Only registered user is able to delete user's request.";
	...
	public static final String TERMINATE_ACCOUNT_POSSIBILITY = "Only registered user is able to terminate account.";
	public static final String USER_IN_BAN = "Your account was banned. Please pay off the debt.";
	...
	public static final String WORK_WITH_PAYMENT_POSSIBILITY = "Only registered user is able to see informaton about user's payments.";
