...
function validateForm(event)
{
	...
	if(document.signUpForm.nameUser.value=="") {
		alert("User name can not be empty");
		document.signUpForm.nameUser.focus();
		return false;
		}
	else if(document.signUpForm.surnameUser.value=="") {
		alert("User surname can not be empty");
		document.signUpForm.surnameUser.focus();
		return false;
		}
	else if(document.signUpForm.loginUser.value=="") {
		alert("Login can not be empty");
		document.signUpForm.loginUser.focus();
		return false;
		}
	else if(document.signUpForm.passwordUser.value=="") {
		alert("Password can not be empty");
		document.signUpForm.passwordUser.focus();
		return false;
		}
	else if(document.signUpForm.passwordUserRep.value=="") {
		alert("Password can not be empty");
		document.signUpForm.passwordUserRep.focus();
		return false;
		}
	else if (document.signUpForm.passwordUser.value != document.signUpForm.passwordUserRep.value) {
	...
	else if(document.signUpForm.emailUser.value=="") {
		alert("E-mail can not be empty");
		document.signUpForm.emailUser.focus();
		return false;
		}
	else if(document.signUpForm.birthDateUser.value=="") {
		alert("Birth date can not be empty");
		document.signUpForm.birthDateUser.focus();
		return false;
		}
	else if(document.signUpForm.phoneUser.value=="") {
		alert("Phone can not be empty");
		document.signUpForm.phoneUser.focus();
		return false;
		}
	else {
